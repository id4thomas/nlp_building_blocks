"""Provenance utils for determining the source of the data in file"""
import copy
...
# https://github.com/DS4SD/docling-core/blob/b787d53173e9e2325f25f03a7e442d5b4194e5a4/docling_core/types/doc/base.py
